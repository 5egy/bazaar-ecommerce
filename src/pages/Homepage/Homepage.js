...
<h1 className='text-3xl md:text-6xl hot-deal font-black'>Hottest Deal 🔥 </h1>
<p className='text-xl mt-6'>{product.details}</p>
<Link href={`/product/${product.slug.current}`} className='bg-gradient-to-r shadow-md hover:shadow-[#6a2d72]  duration-500 from-[#6a2d72] to-[#e83cff] text-white mt-5 w-4/5 mx-auto p-3 rounded-md'>Buy Now</Link>
